...
const unsigned int nSoundEvents = 4;
// TODO: change me
const float soundInterval = 5.f * 1000;              // ms
const float timeoutSound = 10.f * 1000;              // ms

void noiseSensorISR()
{
    Serial.println("Hi from noiseSensorISR");
    digitalWrite(11, !digitalRead(NOISE_SENSOR_PIN));
}
